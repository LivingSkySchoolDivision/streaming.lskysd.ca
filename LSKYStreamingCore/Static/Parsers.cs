...
namespace LSKYStreamingCore
{
    public static class Parsers
    {
        ...
        {
            int ParsedYear = Parsers.ParseInt(year);
            int ParsedMonth = Parsers.ParseInt(month);
            int ParsedDay = Parsers.ParseInt(day);
            int ParsedHour = Parsers.ParseInt(hour);
            int ParsedMinute = Parsers.ParseInt(minute);
            int ParsedSecond = Parsers.ParseInt(second);
